...
class MaskRCNN(object):
    ...
    def unmold_detections(self, detections, mrcnn_mask, original_image_shape,
                          image_shape, window, binary_masks=True, threshold=0.5):
        ...
        for i in range(N):
            ...
            full_mask = utils.unmold_mask(masks[i], boxes[i], original_image_shape, binary_masks=binary_masks, threshold=threshold)
    ...
    def detect(self, images, verbose=0, binary_masks=True, threshold=0.5):
        ...
        for i, image in enumerate(images):
            final_rois, final_class_ids, final_scores, final_masks =\
                self.unmold_detections(detections=detections[i],
